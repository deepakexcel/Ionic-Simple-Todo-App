angular.module('starter.controllers', [])
        .controller('AddTodoCtrl', function (Alertuser, $timeout, $ionicHistory, $ionicNavBarDelegate, $window, $ionicLoading, $ionicPopup, $cordovaNetwork, $scope, $state, $rootScope, $q, ConnectParse, $localStorage) {
...
//                } else {
//                    $ionicNavBarDelegate.title('ToDo');
//                }
//            }
                                    ...
                                    if (objstatus === true) {
                                        ...
                                        deleteRecord.then(
                                                function (result) {
                                                    ...
                                                    $localStorage["todoTasks"] =localTask1[i];
                                                }, function (error) {
