  ...
  angular.module('ui.bootstrap.datetimepicker', [])
    ...
    .directive('datetimepicker', ['$log', 'dateTimePickerConfig', function datetimepickerDirective($log, defaultConfig) {
      ...
      return {
        ...
        '           <th class="switch" id="thmid" colspan="5" data-ng-show="data.previousViewDate.selectable" data-ng-click="changeView(data.previousView, data.previousViewDate, $event)"><span>SELECT</span></th>' +
        '           <th class="right"  data-ng-show="data.rightDate.selectable"></th>' +
        '       </tr>' +
