...
'use strict';
        ...
        $log.error('Please DO NOT specify the dropdownSelector option unless you are using jQuery AND Bootstrap.js. ' +
                ...
                restrict: 'E',
                        ...
                        '           <th class="left" data-ng-click="changeView(data.currentView, data.leftDate, $event)" data-ng-show="data.leftDate.selectable"><i class="ion-arrow-left-b"/></th>' +
                        '           <th class="switch" id="thmid" colspan="5" data-ng-show="data.previousViewDate.selectable" data-ng-click="changeView(data.previousView, data.previousViewDate, $event)"><span data-ng-if="data.currentView === \'day\'">{{ data.previousViewDate.display }}</span></th>' +
                        '           <th class="right" data-ng-click="changeView(data.currentView, data.rightDate, $event)" data-ng-show="data.rightDate.selectable"><i class="ion-arrow-right-b"/></th>' +
                        '       </tr>' +
                        '       <tr data-ng-if="data.currentView !== \'day\'">' +
                        '           <th class="left"  data-ng-show="data.leftDate.selectable"></th>' +
//        '           <th class="switch" id="thmid" colspan="5" data-ng-show="data.previousViewDate.selectable" data-ng-click="changeView(data.previousView, data.previousViewDate, $event)"><span>{{ data.previousViewDate.display }}</span></th>' +
                        ...
                        '           </td>' +
                        '       </tr>' +
                        '       <tr data-ng-if="data.currentView === \'day\'" data-ng-repeat="week in data.weeks" disabled>' +
                        '           <td data-ng-repeat="dateObject in week.dates" ' +
                        '               data-ng-click="changeView(data.nextView, dateObject, $event); pastDisable(dateObject)"' +
                        '               class="day" ' +
...
//                  console.log(monthMoment);
                                                ...
                                                'utcDateValue': monthMoment.valueOf(),
                                                        ...
                                                        'past': monthMoment.isBefore(new Date().toDateString()),
...
//                    console.log(dateValue.past);
                                ...
                                scope.pastDisable = function (pstobj){
                                console.log("Hello Call");
                                        console.log(pstobj.display);
                                       
                                        console.log(pstobj);
                                        console.log(pstobj.past);
                                }
